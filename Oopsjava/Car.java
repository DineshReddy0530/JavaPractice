public class Car extends Vehicle{
    ...
    public Car(String name,String color, String model,String company,String engine,
                boolean powerSteering, boolean ledScreen){
    ...
    //     return "Name of the company: "+ super.getCompany();
    // }
